class UsersController < ApplicationController
  ...
  def create
    ...
    # new user defaults to "user" role and receiving emails.
    @user.role = :user
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :password_hash, :password_salt, :auth_token, :role, :password_reset_token, :password_reset_sent_at, :confirmation_token, :is_confirmed, :send_emails)
    end
